        ...
        if len(row) > 0 :
            ...
            if times >= last_date:
                if times >= step_time:
                    ...
                    av_Veranda = av_Veranda + row[1]
                    av_Wohnzimmer = av_Wohnzimmer + row[2]
                    av_Schlafzimmer = av_Schlafzimmer + row[3]
                    av_Badezimmer = av_Badezimmer + row[4]
                    av_Elektrik = av_Elektrik + row[5]
                    av_Carport = av_Carport + row[6]
                    c = c + 1
